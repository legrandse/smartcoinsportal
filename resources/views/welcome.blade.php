      ...
      <div class="container">
        ...
        <div class="row " data-aos="fade-up" data-aos-delay="100">
          <div class="col-xl-6 col-lg-8">
            ...
            <h2> au service </h2>
            <h2><span>de vos transactions</span></h2>
            <p>Smartcoins, la solution intelligente <br>
              pour distribuer, gérer et sécuriser <br>
              vos jetons en tout simplicité.

            </p>
          </div>
        </div>

        <div class="row gy-4 mt-5 " data-aos="fade-up" data-aos-delay="200">
          <div class="col-xl-2 col-md-4" data-aos="fade-up" data-aos-delay="300">
            <div class="icon-box">
              <i class="bi bi-binoculars"></i>
              <h3 class="text-uppercase"><a href="">Sécurisé</a></h3>
              
            </div>
            <p class="fs-5">Transactions fiables <br>
               et sécurisées</p>
          </div>
          <div class="col-xl-2 col-md-4" data-aos="fade-up" data-aos-delay="400">
            <div class="icon-box">
              <i class="bi bi-bullseye"></i>
              <h3 class="text-uppercase"><a href="">Intelligent</a></h3>
              
            </div><p class="fs-5">Gestion à distance <br>
               et en temps réel</p>
          </div>
          <div class="col-xl-2 col-md-4" data-aos="fade-up" data-aos-delay="500">
            <div class="icon-box">
              <i class="bi bi-fullscreen-exit"></i>
              <h3 class="text-uppercase"><a href="">Performant</a></h3>
              
            </div><p class="fs-5">Conçu pour une <br>
   ...
   <!-- <section id="clients" class="clients section">
    ...
    <section id="features" class="features section">
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          <div class="features-image col-lg-6" data-aos="fade-up" data-aos-delay="100"><img src="assets/img/features-bg.png" alt=""></div>
          <div class="col-lg-6">

            <div class="features-item d-flex ps-0 ps-lg-3 pt-4 pt-lg-0" data-aos="fade-up" data-aos-delay="200">
              <i class="bi bi-archive flex-shrink-0"></i>
              <div>
                <h4>Nous concevons</h4>
                <p>des distributeurs de jetons alliant robustesse, ingéniosité et technologie de pointe</p>
              </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item position-relative">
              ...
              <p>Installation par nos soins.</p>
            </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <p>Afin de maintenir un fonctionnement de qualité, il est préconiser d'entretenir le matériel 1x par an.</p>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="service-item position-relative">
              ...
              <p>A votre demande, nous pouvons customiser l'apparence du distributeur.</p>
            </div>
          </div><!-- End Service Item -->
{{--
      ...
      <div class="row justify-content-center" data-aos="zoom-in" data-aos-delay="100">
        <div class="col-xl-10">
          <div class="text-center">
            <h3>Modernisez votre système d'encaissement dès aujourd'hui</h3>
            <p>Simplifiez la gestion de vos jetons, sécurisez vos recettes et offrez une expérience fluide à vos clients 24h/24. Contactez-nous pour un devis personnalisé.</p>
